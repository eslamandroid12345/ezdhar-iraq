    ...
    <div class="container-fluid">
        <div class="d-flex">
            <a class="header-brand d-md-none" href="#">
                <img src="{{asset('assets/admin/images/logo.png')}}" class="header-brand-img mobile-icon" alt="logo">
                <img src="{{asset('assets/admin/images/logo.png')}}" class="header-brand-img desktop-logo mobile-logo" alt="logo">
            </a>
...
{{--                        </a>--}}
                        <a class="dropdown-item" href="https://topbusiness.io/contact3.html" target="_blank">
